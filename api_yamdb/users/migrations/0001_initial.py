    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('admin', 'Администратор'), ('moderator', 'Модератор'), ('user', 'Пользователь')], default='user', max_length=25, verbose_name='роль пользователя')),
                ('bio', models.TextField(blank=True, verbose_name='биография пользователя')),
                ('confirmation_code', models.CharField(default='00000', max_length=250, null=True, verbose_name='код подтверждения')),
